...
def options():
    ...
    parser.add_argument('--poison_path', default='/usr/project/xtmp/zh127/tiny/', type=str)
    # parser.add_argument('--data_path', default='/usr/project/xtmp/zh127/data', type=str)
    parser.add_argument('--data_path', default='/usr/project/xtmp/zh127/data/tiny-imagenet-200', type=str)
    ###########################################################################
